...
INITIAL_ADMIN_EMAIL = os.getenv("INITIAL_ADMIN_EMAIL", "admin@webtania.ro")
INITIAL_ADMIN_PASSWORD = os.getenv("INITIAL_ADMIN_PASSWORD", "webtania2026")
INITIAL_MANAGER_EMAIL = os.getenv("INITIAL_MANAGER_EMAIL", "manager@webtania.ro")
INITIAL_MANAGER_PASSWORD = os.getenv("INITIAL_MANAGER_PASSWORD", "managerpass2026")

INVALID_CREDENTIALS_DETAIL = "Credențiale invalide."
AUTH_REQUIRED_DETAIL = "Autentificare necesară."
INVALID_SESSION_DETAIL = "Sesiune invalidă sau expirată."
FORBIDDEN_DETAIL = "Nu aveți permisiunea de a efectua această acțiune."
